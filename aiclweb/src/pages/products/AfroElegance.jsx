...
const AfroElegance = () => {
  ...
  return (
    <Layout headerStyle={5} footerStyle={5}   wrapperCls="home_5">
        <BannerContact />
        <Breadcrumb breadcrumbTitle="AFROELEGANCE - UI/ UX  DESIGN SERVICES  & UI/UX AUDIT " />
        <div>
                                                    ...
                                                    <div className="inner-box">
                                                        <div className="top-content">
                                                            <div className="row m-0 justify-content-between">
                                                                <div className="category">KILIMANJARO AFROELEGANCE</div>
                                                                <div className="price"><span>Tshs</span>3,800,000 <sub></sub></div> up to <div className="price"><span>Tshs</span>7,600,000 <sub></sub></div>
                                                            </div>
                                                        </div>
                                                        <div className="lower-content">
                                                            <h5>Most Recommended</h5>
                                                             <h4> Dedicated to collaborating to achieve exceptional results tailored to your requirements.</h4> 
                                                            <ul>
                                                                <li><i className="flaticon-tick" />A fundamental UI Kit</li>
                                                                <li><span><i className="flaticon-right-arrow" />containing designed elements</span></li>
